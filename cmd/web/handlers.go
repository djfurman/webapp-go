...
// TransactionData is the type for transaction information shared between handlers
...
func (app *application) GetTransactionData(r *http.Request) (TransactionData, error) {
	...
	// Use the Stripe API to call for the current states
	card := cards.Card{
...
func (app *application) PaymentSucceeded(w http.ResponseWriter, r *http.Request) {
	...
	customerID, err := app.SaveCustomer(txnData.CustomerFirstName, txnData.CustomerLastName, txnData.Email)
	if err != nil {
		app.errorLog.Println(err)
		return
	}
